  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <ChevronDownIcon className="pointer-events-none size-4 text-[var(--color-text-tertiary)]" />
        }
      />
    </SelectPrimitive.Trigger>
  );
...
function SelectLabel({ className, ...props }: SelectPrimitive.GroupLabel.Props) {
  return (
    <SelectPrimitive.GroupLabel
      ...
      className={cn("px-2 py-1.5 text-xs text-[var(--color-text-tertiary)]", className)}
      {...props}
    />
  );
}
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "focus:bg-[rgba(74,94,72,0.08)] focus:text-[var(--color-sage-800)]",
    ...
    >
      ...
      >
        <CheckIcon className="pointer-events-none size-4 text-[var(--color-sage-600)]" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  );
}
